...
<html lang="en" >
    <head>
        ...
        <meta property="og:url" content="https://interface.dsrp.online">
        <meta property="og:description" content="DownSouthRP Interface">
        
        <!-- SITE TAB TITLE -->
        <title>DSRP Interface</title>
        
        <!-- RESET CSS -->
        <link rel="stylesheet" href="/assets/reset.css">

        <!-- FAVICON -->
        <link rel="shortcut icon" href="/assets/imgs/interfaceIcon2.png" type="image/png">
